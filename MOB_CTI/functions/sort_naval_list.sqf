/*
	...
	create the naval boat list for a given faction
	
*/
//////////////////////////////////////////////////////////////////////////////
_faction = _this;

_staticcost = [_faction,1,"boat"] call read_twod_array_col;

_staticclass = [_faction,0,"boat"] call read_twod_array_col;
