/*
	...
	create the heavy vehicle list for a given faction
	
*/
//////////////////////////////////////////////////////////////////////////////
_faction = _this;

_staticcost = [_faction,1,"heavy"] call read_twod_array_col;

_staticclass = [_faction,0,"heavy"] call read_twod_array_col;
