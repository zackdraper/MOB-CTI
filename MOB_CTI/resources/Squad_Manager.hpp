class liberation_squad {
	...
	controls[] = {"OuterBG", "RecycleBG","OuterBG_F", "InnerBG", "InnerBG_F", "OuterCenterPanel","Header","SquadList","DeployMap", "ButtonClose",
		...
		"ResupplyButton", "RemoveButton", "ReplaceButton", "ConfirmButton", "CancelButton", "PiPZone", "BoardVehicleButton"};
	...
	class SquadList : StdListBox {
		...
		w = 0.12 * safezoneW;
		y = 0.25 * safezoneH + safezoneY;
		h = (0.3 * safezoneH) - (1.5 * BORDERSIZE);
		shadow = 2;
		onLBSelChanged="";
	};
	class BoardVehicleButton : StdButton{
		idc = 215;
		x = (0.2 * safezoneW + safezoneX);
		...
		text = $STR_BOARDVEHICLE;
		tooltip = $STR_BOARDVEHICLE_TOOLTIP;
