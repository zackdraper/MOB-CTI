...
=======
_bed attachTo[_house,[0,0.15,0.34]];
_blanket attachTo[_house,[0,0.15,0.76]];_blanket setDir 270;
_pillow attachTo[_house,[-.8,0.15,0.79]];
_rack attachTo[_house,[-3.15,0.15,1.06]];_rack setDir 270;
_fridge attachTo[_house,[-3.02,1,.8]];_fridge setDir 270;
_table attachTo[_house,[-2.64,3.75,.71]];_table setDir 270;
_chair attachTo[_house,[-3,3.1,.3]];_chair setDir(random 60)+180;
_can attachTo[_house,[3.35,4.18,.6]];
_flag1 attachTo[_house,[3.58,2,1.8]];_flag1 setDir 90;
>>>>>>> 07f0a89e0c6448f803f3e8d796a0852406ba09ff
...
=======
	...
	if(count _guyHome>0)then{
	private _light=createVehicle["#lightpoint",[0,0,0],[],0,"can_collide"];
	_light attachTo[_house,[3.45,-0.86,2.5]];
>>>>>>> 07f0a89e0c6448f803f3e8d796a0852406ba09ff
