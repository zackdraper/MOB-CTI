...
=======
_shovel1 attachTo[_house,[4.8,2.05,.814]];_shovel1 setDir 20;
_can1 attachTo[_house,[-5.7,3.7,1.13]];_can1 setDir 20;
_can2 attachTo[_house,[-5.6,3.2,1.13]];_can2 setDir 0;
_mask attachTo[_house,[-7,-3.7,1.689]];_mask setDir 20;
_bucket1 attachTo[_house,[-7,-3.7,.93]];_bucket1 setDir(random 359);
_bucket2 attachTo[_house,[-6,-3.9,.93]];_bucket2 setDir(random 359);
_glove1 attachTo[_house,[-7.6,-3.8,1.679]];_glove1 setDir 40;
_glove2 attachTo[_house,[-7.42,-3.9,1.679]];_glove2 setDir 80;
_saw1 attachTo[_house,[-7.25,-3.9,1.685]];_saw1 setDir 60;
_hammer attachTo[_house,[-8,-3.85,1.7]];_hammer setDir 60;_hammer setVectorUp[-1,0,0];
_rope attachTo[_house,[5.86,-1.706,1.73]];_rope setVectorUp[-1,0,0];
_shovel2 attachTo[_house,[5.86,-2.02,1.364]];_shovel2 setVectorUp[-1,0,0];
_saw2 attachTo[_house,[5.86,-2.534,1.635]];_saw2 setVectorUp[100,5,-.5];
_crowbar attachTo[_house,[5.86,-2.831,1.482]];_crowbar setVectorUp[-1,0,0];
...
if(dayTime>18 || dayTime<5)then{
	...
	if(count _guyHome>0)then{
	private _light1=createVehicle["#lightpoint",[0,0,0],[],0,"can_collide"];
	_light1 attachTo[_house,[.95,-.02,3.33]];
>>>>>>> 07f0a89e0c6448f803f3e8d796a0852406ba09ff
...
=======
	_light2 attachTo[_house,[5.5, 0.09, 3.20]];
>>>>>>> 07f0a89e0c6448f803f3e8d796a0852406ba09ff
