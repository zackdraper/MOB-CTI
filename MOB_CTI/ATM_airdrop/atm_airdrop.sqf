...
call compile preprocessFileLineNumbers "MOB_CTI\ATM_airdrop\functions.sqf";
...
_target = player;
RedOn = _target addAction["<t color='#B40404'>Chemlight Red On</t>", "MOB_CTI\ATM_airdrop\atm_chem_on.sqf",["Chemlight_red"],6,false,false,"","_target == ( player)"];
BlueOn = _target addAction["<t color='#68ccf6'>Chemlight Blue On</t>", "MOB_CTI\ATM_airdrop\atm_chem_on.sqf",["Chemlight_blue"],6,false,false,"","_target == ( player)"];
YellowOn = _target addAction["<t color='#fcf018'>Chemlight Yellow On</t>", "MOB_CTI\ATM_airdrop\atm_chem_on.sqf",["Chemlight_yellow"],6,false,false,"","_target == ( player)"];
GreenOn = _target addAction["<t color='#30fd07'>Chemlight Green On</t>", "MOB_CTI\ATM_airdrop\atm_chem_on.sqf",["Chemlight_green"],6,false,false,"","_target == ( player)"];
IrOn = _target addAction["<t color='#FF00CC'>Strobe IR On</t>", "MOB_CTI\ATM_airdrop\atm_chem_on.sqf",["NVG_TargetC"],6,false,false,"","_target == ( player)"];
