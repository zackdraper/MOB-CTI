...
if (_ltcolor =="Chemlight_Red") then {
        RedOff = _caller addAction["<t color='#B40404'>Chemlight Red OFF</t>", "MOB_CTI\ATM_airdrop\atm_chem_off.sqf",[_ltcolor],6,false,false,"", "_target == ( player)"];
...
if (_ltcolor =="Chemlight_Blue") then {
        actionBlueOff = _caller addAction["<t color='#68ccf6'>Chemlight Blue OFF</t>", "MOB_CTI\ATM_airdrop\atm_chem_off.sqf",[_ltcolor],6,false,false,"","_target == ( player)"];
...
if (_ltcolor =="Chemlight_Yellow") then {
        actionYellowOff = _caller addAction["<t color='#fcf018'>Chemlight Yellow OFF</t>", "MOB_CTI\ATM_airdrop\atm_chem_off.sqf",[_ltcolor],6,false,false,"", "_target == (player)"];
...
if (_ltcolor =="Chemlight_Green") then {
        actionGreenOff = _caller addAction["<t color='#30fd07'>Chemlight Green OFF</t>", "MOB_CTI\ATM_airdrop\atm_chem_off.sqf",[_ltcolor],6,false,false,"", "_target == ( player)"];
...
if (_ltcolor =="NVG_TargetC") then {
        actionIROff = _caller addAction["<t color='#FF00CC'>Strobe IR OFF</t>", "MOB_CTI\ATM_airdrop\atm_chem_off.sqf",[_ltcolor],6,false,false,"", "_target == ( player)"];
